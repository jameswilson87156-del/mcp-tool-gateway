...
MCP Tool Gateway 当前是 **portfolio demo / learning project**。P1–P5D 已完成，P6 负责 GitHub 展示、简历证据、面试问答和项目边界收口。
...
- Add MCP JSON-RPC compatibility layer、capability negotiation 和标准 transport。
